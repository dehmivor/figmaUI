  ...
  return (
    ...
    >
      ...
      <Stack direction="row" spacing={1} alignItems="center">
        ...
        <AvatarGroup max={4}>
          <Avatar alt="User 1" src={`${process.env.PUBLIC_URL}/person1.jpg`} />
          <Avatar alt="User 2" src={`${process.env.PUBLIC_URL}/person1.jpg`} />
          <Avatar alt="User 3" src={`${process.env.PUBLIC_URL}/person1.jpg`} />
          <Avatar alt="User 4" src={`${process.env.PUBLIC_URL}/person1.jpg`} />
        </AvatarGroup>
      </Stack>
